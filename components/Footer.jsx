  ...
  return (
    <div className='w-full footer pb-10 flex flex-col  items-center bottom-0'>
        ...
        <div className='w-full flex flex-col sm:flex-row justify-between items-end p-2 lg:p-2'>
            <div className='md:ml-10 lg:ml-0 ml-2 w-full sm:w-3/4'>
                ...
                <div className='sm:text-end text-center  h-full w-full text-xs md:text-sm lg:text-sm mt-3 md:mt-0 lg:mt-0  text-lime-700'>
