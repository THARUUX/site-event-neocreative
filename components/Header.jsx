...
export default function Header() {
  ...
  return (
    <div className='header w-full flex justify-center top-0 z-10'>
    <Center>
      {loading && <Loading />}
      
      <header className='w-full px-0 py-6'>
          <div className={"flex justify-between w-full items-center flex-wrap gap-5"}>
            ...
            <nav className={`hidden gap-10 mr-5 lg:flex flex-grow justify-end`} data-aos='fade-in'>
                <div className='nav-items' data-aos='fade-left' data-aos-delay="0">
                  <Link href={'/'} onClick={() => (setLoading(true))} className='flex gap-2 items-center text-main-dark '>
                ...
                {/*<div className='nav-items' data-aos='fade-left' data-aos-delay="300">
                  <Link href={'/categories'} onClick={() => (setLoading(true))} className='flex gap-2 items-center text-main-dark'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
                ...
                <div className='nav-items' data-aos='fade-left' data-aos-delay="600">
                  <Link href={'/products'} onClick={() => (setLoading(true))} className='flex gap-2 items-center text-main-dark'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
                ...
                <div className='nav-items' data-aos='fade-left' data-aos-delay="900">
                  <Link href={'/about'} onClick={() => (setLoading(true))} className='flex gap-2 items-center text-main-dark'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
                ...
                <div className='nav-items' data-aos='fade-left' data-aos-delay="1200">
                  <Link href={'/cart'} onClick={() => (setLoading(true))} className='flex gap-2 items-center text-main-dark'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
